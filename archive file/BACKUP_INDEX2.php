...
query_posts($query_string . "post_type=Properties&post_status=publish&posts_per_page=3");
if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
          <div class="item">
	<?php if ( has_post_thumbnail() ) {the_post_thumbnail(array(1500,550), array('class' => 'front_page_thumb'));} ?>
          <div class="container">
